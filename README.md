# ShowTick - Movie Ticket Booking System

ShowTick is a premium movie ticket booking platform built with **Django REST Framework** (Backend) and **React + Vite** (Frontend). It features a modern UI with glassmorphism, interactive seat selection, and a robust booking engine.
...
This section outlines the functional breakdown and development timeline for ShowTick.

### 🗺️ Roadmap (Gantt Chart)
...
## 🛠️ Technology Stack
- **Frontend**: React, Vite, Axios, Lucide-React, Pure CSS (Glassmorphism).
